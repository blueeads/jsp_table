	...
	<div class = "container">
		<div class ="row">
				<table class = "table table-striped" style="text-align:center; border: 1px solid #dddddd">
					<thead>
						<tr>
							<th colspan="3" stlye="background-color: #eeeeee; text-align: center;;">게시판 글 보기</th>
					...
					%>
						...
						<a onclick="return confirm('삭제하시겠습니까?')" href="deleteAction %>" class="btn btn-primary">삭제</a>
					<%
						}
					%>
				</table>
